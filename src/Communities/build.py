...
_R_FILES = {'c2e': PathTemplate('$data/community/update_curated_cmnt_map_231201.pkl').substitute(),
            'c2k': PathTemplate('$data/community/cmnt_to_keyw_matchform_231201.pkl').substitute()}
