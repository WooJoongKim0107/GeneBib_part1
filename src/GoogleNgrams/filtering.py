...
R_FILES = {'ngrams': PathTemplate('/home/data/01_data/wc_ngram_curation/1903182220KPO.${n}gramOnSort'),
           'nonME': PathTemplate('/home/data/01_data/wc_ngram_curation/1908272135ZKO.ngramSorted_nonME').substitute(),
